/****** FILE: components/bower/jquery/dist/jquery.min.js *****/
...
/****** FILE: components/bower/bootstrap-sass-official/assets/javascripts/bootstrap.js *****/
...
/****** FILE: components/bower/jQuery.mmenu/dist/js/jquery.mmenu.min.js *****/
...
/****** FILE: themes/roulston/js/Application_Layout.js *****/

var Application_Layout=(function(){"use strict";function initMobileNavigation(){$(document).ready(function(){$("#mobile-navigation").mmenu({navbar:{title:'Roulston Criminal Defence Firm'},extensions:["border-full","pageshadow"]});var API=$("#mobile-navigation").data("mmenu");$(".mobile-navigation-toggle").click(function(){API.open();});});}
function initAccordions(){$('.panel-collapse').on('show.bs.collapse',function(){$(this).parent().find('a').removeClass('collapsed');});$('.panel-collapse').on('hide.bs.collapse',function(){$(this).parent().find('a').addClass('collapsed');});}
function init(){$(document).ready(function(){initMobileNavigation();initAccordions();});}
return{init:init};})();Application_Layout.init();;
